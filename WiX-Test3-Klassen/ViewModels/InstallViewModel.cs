...
namespace WiX_Test3_Klassen.ViewModels
{
    public class InstallViewModel : NotificationObject
    {
        ...
        public InstallState State
        {
            ...
            set
            {
                ...
                {
                    this.state = value;
                    this.Message = "Status: " + this.state.ToString();
        ...
        public InstallViewModel(BootstrapperApplicationModel model)     // Konstruktor
        {
            this.model = model;
        ...
        {
            if (e.PackageId.Equals("WiX-Test2.msi", StringComparison.Ordinal))
            {
